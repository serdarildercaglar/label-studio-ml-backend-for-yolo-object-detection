...
class YOLOv10Model(LabelStudioMLBase):
    def __init__(self, **kwargs):
        ...
        model_path = '/mnt/sdb1/indivitech/question-detection/ortaokul/model-training/runs/detect/train4/weights/best.pt'
        ...
        self.labels_in_config = {"q"}  # Replace with your actual labels
            ...
            for box in boxes:
                ...
                temp_result.append({
                    ...
                    "value": {
                        ...
                        "height": height,
                        "rotation": 0,
                        "rectanglelabels": ["q"]  # Manually set the label to "q"
                    },
